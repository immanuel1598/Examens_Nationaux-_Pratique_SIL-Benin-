    ...
    <div class="container">
        ...
        <form action="{{ route('projets.store') }}" method="POST">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control @error('nomProjet') is-invalid @enderror" id="nomProjet" name="nomProjet" value="{{ old('nomProjet') }}">
                @error('nomProjet')
            ...
            <div class="mb-3">
                ...
                <input type="date" class="form-control @error('dateLancement') is-invalid @enderror" id="dateLancement" name="dateLancement" value="{{ old('dateLancement') }}">
                @error('dateLancement')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
